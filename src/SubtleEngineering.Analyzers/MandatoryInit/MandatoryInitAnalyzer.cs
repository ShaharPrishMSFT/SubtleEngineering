    ...
    public class MandatoryInitAnalyzer : DiagnosticAnalyzer
    {
        ...
        public static readonly ImmutableArray<DiagnosticDescriptor> Rules = ImmutableArray.Create(
            new DiagnosticDescriptor(
                DiagnosticIds.MandatoryInit.PropertyIsMissingRequired,
            ...
            new DiagnosticDescriptor(
                DiagnosticIds.MandatoryInit.OnlyOneConstructorAllowedWhenMissingRequired,
        ...
        private static IEnumerable<AttributeData> GetMandatoryAttribute(ISymbol typeParameter)
        {
            ...
            {
                if (attribute.AttributeClass.IsAssignableTo<MandatoryInitAttribute>())
                {
